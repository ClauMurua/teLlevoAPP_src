...
export class HomePage implements OnInit, OnDestroy {
  ...
  shouldShowCard(cardType: string): boolean {
    if (!this.logueado) return true;
    if (cardType === 'ofrecer') return this.userRole === 'conductor';
    if (cardType === 'buscar') return this.userRole === 'pasajero';
    return true; // Para la tarjeta de "mis viajes"
  }
