...
describe('OfrecerViajePage', () => {
  ...
  beforeEach(async () => {
    ...
    // Configurar el adaptador de fecha después de la creación del componente
  ...
  it('debería actualizar climaData cuando la búsqueda es exitosa', () => {
    ...
    expect(component.climaData).toEqual({
      icono: 'http://openweathermap.org/img/wn/01d@2x.png',
      temperatura: 20,
